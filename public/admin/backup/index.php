                    ...
                    <div class="card-body">
                        <form action="#" class="gray-form" method="post">
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-6">
                                        <label for="">Enter type of backup</label>
                                        <select name="backup_type" id="" class="form-control">
                            ...
                            <div class="form-group start-adding-question" align="center">
                                <button type="submit" class="btn btn-secondary" name="submit">Do Backup</button>
                            </div>
                        </form>
                    </div>
                </div>
